...
class TC15ScriptContractTests(unittest.TestCase):
    ...
    def test_readiness_wait_follows_bounded_observed_keyboard_submission(self):
        ...
        self.assertIn('api.keyboard.key("End")', submitter)
        ...
        self.assertIn("current.panel === NEW_SCORE_BOTTOM_PANEL", submitter)
        self.assertIn("End made no navigation progress", submitter)
        self.assertIn("Expected Done after End", submitter)
